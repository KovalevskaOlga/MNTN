...
})({"8keaJ":[function(require,module,exports,__globalThis) {
...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    form.addEventListener("submit", (e)=>{
        ...
        for(let i = 1; i <= 7; i++){
            ...
            if (answer && scoreMap[answer]) totalScore += scoreMap[answer];
        }
        let level = "";
        if (totalScore <= 7) level = "Novice Hiker";
        else if (totalScore <= 14) level = "Moderate Hiker";
        else if (totalScore <= 18) level = "Advanced Moderate Hiker";
        else if (totalScore <= 20) level = "Expert Hiker";
        else level = "Expert Backpacker";
...
},{}]},["8keaJ","5IrjP"], "5IrjP", "parcelRequire9616", {})
